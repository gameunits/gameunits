...
// test_gameunits --log_level=all  --run_test=smsg_tests
...
BOOST_AUTO_TEST_CASE(smsg_test)
{
    ...
    const std::string sTestMessage =
        "GAMEUNITS is a Proof of Stake crypto currency, utilizing cutting edge technology, "
        "such as instant p2p encrypted messaging, and anonymous dual-key stealth addresses. "
