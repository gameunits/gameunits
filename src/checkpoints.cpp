...
namespace Checkpoints
{
    ...
    MapCheckpoints mapCheckpoints =
        ...
        (  0, uint256("0x000000743190fbaea62d4748157e22ef44850668c071f3709883b83ef24ec0ff") ) // Params().HashGenesisBlock())
		(300, uint256("0x0000050d9cb141d8c97c778beebb8996306fc26a769ed6baff949b23d15c3a86") ) // Last Pow Block()
    ;

    // TestNet has no checkpoints
    MapCheckpoints mapCheckpointsTestnet =
        boost::assign::map_list_of
        ( 0, uint256("0x0000e6e5fbcd90563e4389c8722e7a2cf00ffbfcd2b0af6b045ebd47abde95d1") ) // hashGenesisBlockTestNet
    ;
