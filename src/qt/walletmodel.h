...
enum eTxnTypeInd
{
    TXT_GAMEUNITS_TO_GAMEUNITS = 0,
    TXT_GAMEUNITS_TO_ANON,
    TXT_ANON_TO_ANON,
    TXT_ANON_TO_GAMEUNITS,
};
...
public:
    ...
    enum StatusCode // Returned by sendCoins
    {
        ...
        SCR_AmountWithFeeExceedsGameunitsXBalance,
        SCR_Error,
        SCR_ErrorWithMsg,
        Aborted
    };
    ...
    qint64 getGameunitsXBalance() const;
...
signals:
    ...
    void balanceChanged(qint64 balance, qint64 gameunitsXBal, qint64 stake, qint64 unconfirmedBalance, qint64 immatureBalance);
