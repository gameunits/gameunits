...
QString GameunitsBridge::newAddress(QString addressLabel, int addressType, QString address, bool send)
{
...
QString GameunitsBridge::lastAddressError()
{
    QString sError;
...
QString GameunitsBridge::getPubKey(QString address)
{
...
QString GameunitsBridge::createGroupChat(QString label)
{
...
QString GameunitsBridge::joinGroupChat(QString privkey, QString label)
{
    /*
...
QVariantList GameunitsBridge::inviteGroupChat(QString qsaddress, QVariantList invites, QString from)
{
...
QVariantMap GameunitsBridge::signMessage(QString address, QString message)
{
    QVariantMap result;
...
QVariantMap GameunitsBridge::verifyMessage(QString address, QString message, QString signature)
{
    QVariantMap result;
...
QVariantMap GameunitsBridge::getNewMnemonic(QString password, QString language)
{
    QVariantMap result;
...
QVariantMap GameunitsBridge::importFromMnemonic(QString inMnemonic, QString inPassword, QString inLabel, bool fBip44, int64_t nCreateTime)
{
...
QVariantMap GameunitsBridge::extKeyAccList() {
    QVariantMap result;
...
QVariantMap GameunitsBridge::extKeyList() {
    QVariantMap result;
...
QVariantMap GameunitsBridge::extKeyImport(QString inKey, QString inLabel, bool fBip44, int64_t nCreateTime)
{
    QVariantMap result;
    ...
    if (eKey58.Set58(sInKey.c_str()) == 0)
    {
        ...
        {
            result.insert("error_msg", "Import failed - Key must begin with Gameunits prefix.");
            return result;
        }
...
QVariantMap GameunitsBridge::extKeySetDefault(QString extKeyID)
{
    QVariantMap result;
...
QVariantMap GameunitsBridge::extKeySetMaster(QString extKeyID)
{
    QVariantMap result;
    std::string sInKey = extKeyID.toStdString();
    if (extKeyID.length() == 0)
...
QVariantMap GameunitsBridge::extKeySetActive(QString extKeyID, QString isActive)
{
    QVariantMap result;
    std::string sInKey = extKeyID.toStdString();
